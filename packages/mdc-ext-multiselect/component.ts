  ...
  getDefaultFoundation() {
    return new MDCExtMultiselectFoundation(
      /** @type {!MDCExtMultiselectAdapter} */ (Object.assign({
        ...
        registerDocumentInteractionHandler: (evtType, handler, useCapture) => document.addEventListener(evtType, handler, useCapture),
        deregisterDocumentInteractionHandler: (evtType, handler, useCapture) => document.removeEventListener(evtType, handler, useCapture),
